...
function darwin() {
    ...
    const whichFinds = utils_2.findByWhich(['firefox-nightly'], [{ regex: /firefox-nightly/, weight: 51 }]);
...
function linux() {
    ...
    return utils_2.findByWhich(['firefox-nightly', 'firefox'], [{ regex: /firefox/, weight: 51 }]);
}
function win32() {
    const installations = [];
    const suffixes = [
