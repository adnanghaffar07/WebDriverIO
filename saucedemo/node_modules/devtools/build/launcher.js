...
function launchBrowser(capabilities, product) {
    ...
    else if (product === constants_1.BROWSER_TYPE.firefox && executablePath !== 'firefox' && !executablePath.toLowerCase().includes(constants_1.CHANNEL_FIREFOX_NIGHTLY)) {
